...
0 = server-side auction without interest groups<br>
1 = on-device interest group auction<br>
3 = server-side interest group auction<br>
<br>
...
Information to signal buyer participation in a potential interest group auction for a given ad slot.
...
<table>
  ...
  <tr>
    ...
    <td>One or more InterestGroupAuctionBuyer objects (Section 4.2.5).</td>
 </tr>
  <tr>
    <td><code>ext</code></td>
    <td>object</td>
