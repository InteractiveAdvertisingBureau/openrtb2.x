...
<table>
  ...
  <tr>
    ...
    <td>Currency specified using ISO-4217 alpha codes. This may be different from bid currency returned by bidder if this is allowed by the exchange. This currency applies to all floors specified in the `Video` or `Audio` objects.</td>
  </tr>
  <tr>
