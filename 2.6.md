...
- [7.10 - Upgrade Path for plcmnt Attribute](https://github.com/InteractiveAdvertisingBureau/openrtb2.x/blob/develop/implementation.md#710---using-plcmnt-attribute-in-object-video)
...
<table>
  ...
  <tr>
    ...
    <td>integer</td>
    <td>Video placement type for the impression. Refer to <a href="https://github.com/InteractiveAdvertisingBureau/AdCOM/blob/develop/AdCOM%20v1.0%20FINAL.md#list_plcmntsubtypesvideo">List: Plcmnt Subtypes - Video</a> in AdCOM 1.0.</td>
  </tr>
  <tr>
