...
<table>
  ...
  <tr>
    ...
    <td>integer</td>
    <td>An enumeration indicating how the content was recorded where 0 = pre-recorded content and 1 = real-time. See [Section 7.15 of Implementation Guidance](implementation.md#lea) for additional detail. 
</td>
  </tr>
<tr>
...
See [Section 7.15 of Implementation Guidance](implementation.md#lea) for additional detail. 
</td>
  </tr>
  <tr>
