...
<table>
  ...
  <tr>
    <td><code>igb</code></td>
    <td>array; required <b>PROVISIONAL</b></td>
    <td>One or more InterestGroupAuctionBuyer objects (Section 4.2.5). Required and mutually exclusive with `igs`.</td>
 </tr>
  <tr>
    <td><code>igs</code></td>
    <td>array; required <b>PROVISIONAL</b></td>
    <td>One or more InterestGroupAuctionSeller objects (Section 4.2.6). Required and mutually exclusive with `igb`.</td>
 </tr>	
  <tr>
    <td><code>ext</code></td>
    <td>object</td>
