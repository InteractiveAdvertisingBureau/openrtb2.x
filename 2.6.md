...
<table>
  ...
  <tr>
    ...
    <td>enum array</td>
    <td>Indicates pod deduplication settings that will be applied to bid responses. Refer to <a href="https://github.com/InteractiveAdvertisingBureau/AdCOM/blob/master/AdCOM%20v1.0%20FINAL.md#list--poddedupe-">List: Pod Deduplication</a> in AdCOM 1.0.</td>
  </tr>
  <tr>
    <td><code>ext</code></td>
    <td>object</td>
