...
<br>Unless prior arrangements have been made between the buyer and the seller directly, the value in this field is expected to be derived from an ID sync. (see Appendix: Cookie Based ID Syncing)</br>
    </td>
 </tr>
  <tr>
    <td><code>yob</code></td>
...
</br>For ad tech intermediaries, this would be their domain as used in ads.txt.  For publishers, this would generally correspond to the OWNERDOMAIN or MANAGERDOMAIN.
</td>
 </tr>
  <tr>
    <td><code>source</code></td>
    <td>string</td>
    <td>Canonical domain of the ID.<br></br>
<b>EXAMPLES FOR PUBLIC COMMENT PERIOD ONLY</b>
<li>Examples of a universal ID include “id5.io”, “liveramp.com”, “unifiedid.com”.</li>
<li>Examples of a device ID, e.g. “apple.com”, “samsung.com”, “roku.com”.</li>
    </td>
  </tr>
<tr>
    <td><code>matcher</code></td>
    <td>string</td>
    <td>Technology providing the match method as defined in <code>mm</code>.<br><b>EXAMPLES FOR PUBLIC COMMENT ONLY: LiveIntent, Transunion, LiveRamp</b></br>
...
</br>May be omitted when mm=0, 1, or 2.
</td>
 </tr>
<tr>
    <td><code>mm</code></td>
    <td>int</td>
    <td>Match method used by the <code>matcher</code>. Refer to <a href="https://github.com/InteractiveAdvertisingBureau/AdCOM/blob/master/AdCOM%20v1.0%20FINAL.md#list_agenttypes">List: ID Match Methods</a> in AdCOM 1.0
    </td>
  </tr>
  <tr>
    <td><code>uids</code></td>
    <td>object array</td>
    <td>Array of extended ID <code>UID</code> objects from the given source. Refer to <a href=https://github.com/InteractiveAdvertisingBureau/openrtb2.x/blob/main/2.6.md#3228---object-uid-"3.2.28"</a> Extended Identifier UIDs</td>
 </tr>
  <tr>
    <td><code>ext</code></td>
    <td>object</td>
