...
<table>
  ...
  <tr>
    ...
    <td>Indicates the currency in which interest group bids will be placed. Value must be a three digit ISO 4217 alpha currency code (e.g. "USD").</td>
  </tr>
  ...
  <tr>
    <td><code>eg</code></td>
    <td>integer</td>
    <td>Buyer experiment group ID to be specified in the trusted bidding signals request URL. If specified, the seller will add to its auction config <code>perBuyerExperimentGroupIds</code>code> attribute map, keyed by the interest group buyer origin. See https://github.com/WICG/turtledove/blob/main/FLEDGE.md#31-fetching-real-time-data-from-a-trusted-server<br>
<br>
integer between zero and 65535 (16 bits)</td>
  </tr>
