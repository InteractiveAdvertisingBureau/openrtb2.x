...
## [7. Implementation Notes](implementation.md#7-implementation-notes)

- [7.1 - No-Bid Signaling](implementation.md#71---no-bid-signaling) 

- [7.2 - Impression Expiration](implementation.md#72---impression-expiration)

- [7.3 - PMP & Direct Deals](implementation.md#73---pmp--direct-deals)

- [7.4 - Skippability](implementation.md#74---skippability)

- [7.5 - Regs Resources](implementation.md#75---regs-resources)

- [7.6 - Pod Bidding for Video and Audio](implementation.md#76---pod-bidding-for-video-and-audio)

- [7.7 - Network vs Channel Example Cases](implementation.md#77---network-vs-channel-example-cases)

- [7.8 - Counting Billable Events and Tracked Ads](implementation.md#78---counting-billable-events-and-tracked-ads)

- [7.9 - Digital Out-Of-Home](implementation.md#79---digital-out-of-home)

- [7.10 - Updated Video Signals](implementation.md#710---updated-video-signals)
