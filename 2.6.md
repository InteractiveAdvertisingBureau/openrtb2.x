...
<table>
  ...
  <tr>
    ...
    <td>integer</td>
    <td>The minimum exposure time, in seconds per view, that the (uninterrupted) player will display the creative before refreshing to the next creative. If the field is absent, the exposure time is unknown. If 0, the exposure time is indefinite. For video, please use the fields as described in the <code>Video</code> object (Section 3.2.7).</td>
  </tr>
  <tr>
    <td><code>ext</code></td>
    <td>object</td>
