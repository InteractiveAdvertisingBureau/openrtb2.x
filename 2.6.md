...
<table>
  ...
  <tr>
    ...
    <td>integer array</td>
    <td>Array of the section(s) of the string which should be applied for this transaction. Generally will contain one and only one value, but there are edge cases where more than one may apply. Sections 3 & 4 need not be signaled for this purpose. See the <a href="https://github.com/InteractiveAdvertisingBureau/Global-Privacy-Platform/blob/main/Sections/Section%20Information.md">GPP Section Information</a> for more details.</td>
  </tr>
  <tr>
    <td><code>ext</code></td>
    <td>object</td>
