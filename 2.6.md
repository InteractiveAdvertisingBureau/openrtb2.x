...
Recommended for video and/or apps. </td>
  ...
  <tr>
    ...
    <td>integer</td>
    <td>The minimum exposure time in seconds per view that the creative will be displayed before refreshing to the next creative. If the field is absent, the exposure time is unknown. If 0, the exposure time is indefinite.</td>
  </tr>
  <tr>
    <td><code>qty</code></td>
    <td>object</td>
...
<table>
  ...
  <tr>
    ...
    <td>integer; recommended</td>
    <td>The source type of the quantity measurement, ie. publisher. Refer to the list https://github.com/knittingmedia/AdCOM/blob/master/AdCOM%20v1.0%20FINAL.md#list-multiplier-measurement-source-types- </td>
 </tr>
  <tr>
    <td><code>vendor</code></td>
