...
- [3.2 - Object Specifications](#objectspecs)
	...
	- [3.2.33 - Object: AutoRefresh](#objectautorefresh)
	- [3.2.34 - Object: AutoRefreshSettings](#objectautorefreshsettings)
...
<table>
 ...
 <tr>
  ...
  <tr>
    ...
    <td>3.2.33</td>
    <td>Details about ad slots being refreshed automatically.</td>
    </td>
    </td>
  </tr>
   <td><code>AutoRefreshSettings</code></td>
    <td>3.2.34</td>
    <td>Information on how and when ad units are refreshed.</td>
    </td>
    </td>
  </tr>
</table>
...
<tr>
   ...
   <td><code>AutoRefreshSettings</code></td>
    <td>object</td>
    <td>Information on how and when ad units are refreshed. (Section 3.2.34)</td>
    </tr>
    <td><code>ext</code></td>
    <td>object</td>
    <td>Placeholder for exchange-specific extensions to OpenRTB.</td>
...
### 3.2.33 - Object: AutoRefresh <a name="objectautorefresh"></a>

The minimum exposure time, in seconds per view, that the (uninterrupted) ad creative will be rendered before refreshing to the next creative. If the field is absent, the exposure time is unknown. If 0, the exposure time is indefinite. This field does not account for viewability or external factors such as a user leaving a page.
...
<tr>
    <td><code>refresh_settings</code></td>
    <td> recommended</td>
    <td>The auto-refresh settings that the publisher has on this inventory.</td>
</tr>
  <tr>
...
### 3.2.34 - Object: AutoRefreshSettings <a name="objectautorefreshsettings"></a>

Information on how often and when ads are refreshed. 
...
<tr>
    <td><code>refresh_type</code></td>
    <td> recommended</td>
    <td>The type of the declared auto refresh.<br>
	    Values:<br>
	    Default = UNKNOWN_AUTO_REFRESH_TYPE<br>
	    UNKNOWN_AUTO_REFRESH_TYPE = 0<br>
	    USER_ACTION = 1 - Refresh triggered by user-initiated action such as scrolling.<br>
	    EVENT = 2 - Event-driven content change. For example, ads refresh when the football game score changes on the page.<br>
	    TIME = 3 - Time-based refresh. Ads refresh on a predefined time interval even without user activity.
</td>
</tr>
  <tr>
    <td><code>min_refresh_interval_seconds</code></td>
    <td>integer; recommended</td>
    <td>The minimum refresh interval. This applies to all refresh types.</td>
 </td>
 <tr>
    <td><code>ext</code></td>
    <td>object</td>
...
<table>
  ...
  <tr>
  <td><code>**3.1**</code></td>
    <td>*Object Model* Update to model image to show DOOH and Qty objects</td>
  </tr>
  <tr>
    <td><code>**3.2.3**</code></td>
    <td>*Object: Regs* Additional fields gpp and gpp_sid to support Global Privacy Protection string</td>
 </tr>
  <tr>
    <td><code>**3.2.13, 3.2.14**</code></td>
    <td>*Objects: Site, App* Added inventorypartnerdomain (previously ext)</td>
     <tr>
  </tr>
 <td><code>**3.2.31**</code></td>
 <td>*Object: Qty* New object to describe source of multiplier value in Digital Out of Home </td>
  </tr>
  <tr>
    <td><code>**3.2.32**</code></td>
    <td>**Object: DOOH* New object to support programmatic buys of Digital Out of Home inventory</td>
 </tr>
  <tr>
    <td><code>**7.9**</code></td>
    <td>*Implementation Notes* Addition of notes, examples and best practices for utilizing DOOH</td>
</tr>
</table>
