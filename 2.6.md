...
- [3.2 - Object Specifications](#objectspecs)
	...
	- [3.2.35 - Object: DurFloors](#objectdurfloors)
   	...
   	- [3.2.36 - Object: InterestGroupAuctionSupport](#objectinterestgroupauctionsupport)
...
- [4.2 - Object Specifications](#objectspecs)
	...
	- [4.2.4 - Object: InterestGroupAuctionIntent](#objectinterestgroupauctionintent)
   
	- [4.2.5 - Object: InterestGroupAuctionBuyer](#objectinterestgroupauctionbuyer)
...
- [6.2 - Bid Requests](#6.4bidrequests)
	...
	- [6.2.6 - Example 6 – Native Ad](#example6nativead)
 	...
 	- [6.2.7 - Example 7 – Interest Group Auction Support](#example7igsupport)
...
- [6.3 - Bid Responses](#6.3bidresponses)
	...
	- [6.3.5 - Example 5 – Bid Placed with Interest Group Auction Intent](#)

	- [6.3.6 - Example 6 – No Bid with Interest Group Auction Intent](#)
...
<tr>
    ...
    <td>int array</td>
    <td>Methods of interaction with an advertisement that a placement permits. Refer to <a href="https://github.com/InteractiveAdvertisingBureau/AdCOM/blob/develop/AdCOM%20v1.0%20FINAL.md#list_int_types">List: Interaction Types</a> in AdCOM 1.0.</td>
    </td>
    </td>
  </tr>
  <tr>
    <td><code>igs</code></td>
    <td>object <b>PROVISIONAL</b></td>
    <td>InterestGroupAuctionSupport object (Section 3.2.36). Provided when the Imp supports an interest group auction environment.</td>
  </tr>	
  <tr>
    <td><code>ext</code></td>
    <td>object</td>
...
<table>
  ...
  <tr>
    ...
    <td>Indicates pod deduplication settings that will be applied to bid responses. Refer to <a href="https://github.com/InteractiveAdvertisingBureau/AdCOM/blob/develop/AdCOM%20v1.0%20FINAL.md#list--pod-deduplication-settings-">List: Pod Deduplication</a> in AdCOM 1.0.</td>
  </tr>
  <tr>
...
<table>
  ...
  <tr>
    ...
    <tr>
    <td><code>ifa_type</code></td>
    <td>integer</td>
    <td>Declared source of the device.ifa provided in the bid request. Non-device IDs should be placed in eids. Refer to <a href="https://github.com/InteractiveAdvertisingBureau/AdCOM/blob/master/AdCOM%20v1.0%20FINAL.md#list--ifa_types-">List: IFA Types</a> for values.</td>
  </tr>
  <tr>
...
### 3.2.36 - Object: InterestGroupAuctionSupport <b>PROVISIONAL</b> <a name="objectinterestgroupauctionsupport"></a>
...
<table>
  ...
  <tr>
    <td><code>ae <b>PROVISIONAL</b></code></td>
...
<table>
  ...
  <tr>
    <td><code>InterestGroupAuctionIntent <b>PROVISIONAL</b></code></td>
    <td>4.2.4</td>
    <td>Information to signal buyer participation in a potential interest group auction for a given ad slot.</td>
     </td>
     </td>
  </tr>
  <tr>
    <td><code>InterestGroupAuctionBuyer <b>PROVISIONAL</b></code></td>
    <td>4.2.5</td>
    <td>Information for an interest group auction buyer.</td>
     </td>
     </td>
  </tr>
<tr>
    <td><code>InterestGroupAuctionSeller <b>PROVISIONAL</b></code></td>
    <td>4.2.6</td>
    <td>Information for an interest group auction seller.</td>
     </td>
     </td>
  </tr>
</table>
...
<table>
 ...
 <tr>
    <td><code>igi <b>PROVISIONAL</b></code></td>
    <td>object array</td>
    <td>One or more InterestGroupAuctionIntent objects (Section 4.2.4). Provided when the bidder is signaling intent to participate in interest group auction(s).</td>
  </tr>
  <tr>
    <td><code>ext</code></td>
    <td>object</td>
...
<td>integer</td>
<td>This is the method of interaction required by an ad. Refer to <a href="https://github.com/InteractiveAdvertisingBureau/AdCOM/blob/develop/AdCOM%20v1.0%20FINAL.md#list_int_types">List: Interaction Types</a> in AdCOM 1.0.</td>
</tr>	
  <tr>
    <td><code>ext</code></td>
    <td>object</td>
...
### 4.2.4 - Object: InterestGroupAuctionIntent <b>(PROVISIONAL)</b> <a name="objectinterestgroupauctionintent"></a>

Information to signal participation in a potential interest group auction for a given ad slot. Only one of igb or igs should exist.
...
<table>
  ...
  <tr>
    <td><code>impid</code></td>
    <td>string; required <b>PROVISIONAL</b></td>
    <td>ID of ad slot represented by the corresponding bid request Imp object.  Used to link interest group buyer information to the specific ad slot.</td>
  </tr>
  <tr>
    <td><code>igb</code></td>
    <td>array; optional <b>PROVISIONAL</b></td>
    <td>One or more InterestGroupAuctionBuyer objects (Section 4.2.5). Should always exist unless an igs object exists.</td>
 </tr>
  <tr>
    <td><code>igs</code></td>
    <td>array; optional <b>PROVISIONAL</b></td>
    <td>One or more InterestGroupAuctionSeller objects (Section 4.2.6). Should always exist unless an igb object exists.</td>
 </tr>	
  <tr>
    <td><code>ext</code></td>
    <td>object</td>
...
### 4.2.5 - Object: InterestGroupAuctionBuyer <b>(PROVISIONAL)</b> <a name="objectinterestgroupauctionbuyer"></a>
...
<table>
  ...
  <tr>
    <td><code>origin <b>PROVISIONAL</b></code></td>
    <td>string; required</td>
  ...
  <tr>
    <td><code>maxbid <b>PROVISIONAL</b></code></td>
    <td>double</td>
  ...
  <tr>
    <td><code>cur <b>PROVISIONAL</b></code></td>
  ...
  <tr>
    <td><code>pbs <b>PROVISIONAL</b></code></td>
  ...
  <tr>
    <td><code>ps <b>PROVISIONAL</b></code></td>
    <td>object</td>
...
### 4.2.6 - Object: InterestGroupAuctionSeller <b>(PROVISIONAL)</b> <a name="objectinterestgroupauctionseller"></a>
...
<tr>
    <td><code>impid <b>PROVISIONAL</b></code></td>
    <td>string; required</td>
    <td>ID of ad slot represented by the corresponding bid request Imp object. Used to link interest group seller information to the specific ad slot.</td>
  </tr>
<tr>
    <td><code>config <b>PROVISIONAL</b></code></td>
    <td>object; required</td>
    <td>Auction config for a component seller</td>
  </tr>
  <tr>
    <td><code>ext <b>PROVISIONAL</b></code></td>
    <td>object</td>
    <td>Placeholder for bidder-specific extensions to OpenRTB.</td>
     </td>
     </td>
...
### 6.2.7 - Example 7 – An Imp Signaling Interest Group Auction Support <a name="example7igsupport"></a>
...
### 6.3.5 - Example 5 – Bid Placed with Interest Group Auction Intent <a name=""></a>
...
### 6.3.6 - Example 6 –  No Bid with Interest Group Auction Intent <a name=""></a>
