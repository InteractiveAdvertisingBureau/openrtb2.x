...
| `${AUCTION_PRICE}` | Clearing price using the same currency and units as the bid. This reflects the final price after discount.|
...
| `${AUCTION_DISCOUNT_CPM}` | The discount amount applied by the seller, as a CPM. |
