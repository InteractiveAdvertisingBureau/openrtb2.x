...
<tr>
    ...
    <td>AutoRefreshSettings object; recommended</td>
    <td>An <code>AutoRefreshSettings</code> object (see Section 3.2.34) describing the mechanics of how the ad placement refreshes.</td>
</tr>
  <tr>
