...
| `livestream` | integer | 0 = not live, 1 = content is live (e.g., stream, live blog), 2 = Video On Demand (VOD). <br><br>See [Section 7.15 of Implementation Guidance](implementation.md#livestream) for additional detail.|
