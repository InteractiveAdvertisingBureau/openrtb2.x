...
<table>
  ...
  <tr>
    ...
    <td>integer</td>
    <td>Declared source of the device.ifa provided in the bid request. Non-device IDs should use eids. Refer to <a href="https://github.com/InteractiveAdvertisingBureau/AdCOM/blob/master/AdCOM%20v1.0%20FINAL.md#list--ifa_types-">List: IFA Types</a> for values.</td>
  </tr>
  <tr>
