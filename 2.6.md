...
<table>
  ...
  <tr>
    ...
    <td>integer; recommended</td>
    <td>The source type of the quantity measurement, ie. publisher. Refer to the list [Multiplier Measurement Source Types](https://github.com/knittingmedia/AdCOM/blob/master/AdCOM%20v1.0%20FINAL.md#list-multiplier-measurement-source-types-) </td>
 </tr>
  <tr>
    <td><code>vendor</code></td>
