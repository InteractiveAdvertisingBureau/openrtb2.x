...
<table>
  ...
  <tr>
   ...
   <tr>
    ...
    <td>object array</td>  
    <td>Container for floor price by banner size information, to be used if a given deal is eligible for banner demand. An array of Format objects (see Section 3.2.10).</td>
   </tr>
   <tr>
